...
Redeploy after any change: `npx wrangler deploy` from this folder. It uploads 63 files; dev files
...
## The 20 — in progress (8 of 20)

Paleo, Catan, Coffee Rush, Unstable Unicorns, Sleeping Gods, Eldritch Horror, Keep the Heroes Out!,
Décorum (2026-09-10). Facts Franco asks to check get checked: Sleeping Gods has 13 endings (not ~20);
...
"I played this" mark in the finder). That's why the catalogue is 57, not 50: seven of his games were added; Catan was already there. Copy that mentions the size
